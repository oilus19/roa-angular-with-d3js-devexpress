...
(function ($) {
    ...
    ResponsiveTable.prototype.createButtonToolbar = function() {
        ...
        this.$dropdownGroup = $('<div class="btn-group pull-right" dropdown />');
        this.$dropdownBtn = $('<button class="btn btn-default" dropdown-toggle>Display <span class="caret"></span></button>');
