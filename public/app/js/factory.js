...
angular.module('resultsonair.factory', []).
	...
	factory('$pageLoadingBar', function($rootScope, $window){
		...
		return {
			...
			showLoadingBar: function(options)
			{
				...
				var $ = jQuery,
					$loading_bar = $(".resultsonair-loading-bar");

				if($loading_bar.length == 0)
				{
					$loading_bar = $('<div class="resultsonair-loading-bar progress-is-hidden"><span data-pct="0"></span></div>');
