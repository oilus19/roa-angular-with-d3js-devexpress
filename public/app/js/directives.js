angular.module('resultsonair.directives', []).
	...
	directive('userInfoSidebar', function(){
		return {
			restrict: 'E',
			templateUrl: appHelper.templatePath('layout/user-info-sidebar')
		};
	}).
	directive('pageTitle', function($rootScope){
		return {
			...
			link: function(scope, el, attr){
				...
				$rootScope.page_title = attr.title;
			}
		};
	}).
