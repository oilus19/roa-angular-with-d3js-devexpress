...
app.constant('ASSETS', {
	...
	'resultsonairLib': {
		notes: appHelper.assetPath('js/resultsonair-notes.js'),
	},
	...
	'maps': {
		...
		'vectorMaps': [
			...
			appHelper.assetPath('js/jvectormap/regions/jquery-jvectormap-us-aea.js'),
		],
	},
	...
	'tables': {
		...
		'export': [
			appHelper.assetPath('js/table-export/tableExport.js'),
			appHelper.assetPath('js/table-export/jquery.base64.js'),
			appHelper.assetPath('js/table-export/html2canvas.js'),
			appHelper.assetPath('js/table-export/jspdf/libs/sprintf.js'),
			appHelper.assetPath('js/table-export/jspdf/jspdf.js'),
			appHelper.assetPath('js/table-export/jspdf/libs/base64.js'),
		],
	},
